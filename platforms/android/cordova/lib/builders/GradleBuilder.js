...
GradleBuilder.prototype.prepBuildFiles = function () {
    ...
    subProjects.forEach(function (p) {
        ...
        // ########## This is the diff between the the file generated by Cordova and ours, Cordova has outdated build targets ########## 
        depsList += '    implementation project(\':CordovaLib\')';
        // ########## 
        insertExclude(p);
    });
...
*/
        ...
        /* jshint -W069 */
        var distributionUrl = process.env['CORDOVA_ANDROID_GRADLE_DISTRIBUTION_URL'] || 'https\\://services.gradle.org/distributions/gradle-4.3-all.zip';
        /* jshint +W069 */
